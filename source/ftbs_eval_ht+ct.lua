...
require 'lm.FTBS_LanguageModel_ht+ct'
...
-- Input paths
cmd:option('-model','save/ftbs_ht+ct/model_id_90000.t7','path to model to evaluate')
-- Basic options
cmd:option('-batch_size', 1, 'if > 0 then overrule, otherwise load from checkpoint.')
cmd:option('-num_images', 1000, 'how many images to use when periodically evaluating the loss? (-1 = all)')
