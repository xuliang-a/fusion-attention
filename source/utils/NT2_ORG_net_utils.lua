...
function net_utils.language_eval(predictions, id)
  ...
  utils.write_json('/home/zt/ai/coco-caption/val' .. id .. '.json', out_struct) -- serialize to json (ew, so gross)
  os.execute('/home/zt/ai_ext/newtalk/call_python_caption_eval.sh val' .. id .. '.json') -- i'm dying over here
  local result_struct = utils.read_json('/home/zt/ai/coco-caption/val' .. id .. '.json_out.json') -- god forgive me
